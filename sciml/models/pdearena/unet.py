r"""
Taken and modified from pdearena
"""
...
class Unet(nn.Module):
    ...
    Args:
        ...
        out_channels (int): channels for model output
    ...
    def __init__(
        ...
        if use1x1:
            ...
            self.final = nn.Conv2d(in_channels, self.out_channels, kernel_size=(3, 3), padding=(1, 1))
...
class FourierUnet(nn.Module):
    ...
    def __init__(
        ...
        n_channels = hidden_channels
        # Project image into feature map
        self.image_proj = nn.Conv2d(self.in_channels, n_channels, kernel_size=(3, 3), padding=(1, 1))
