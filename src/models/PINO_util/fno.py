...
class FNO(nn.Module):
    ...
    def __init__(self, n_modes, hidden_channels,
        ...
        if domain_padding is not None and domain_padding > 0:
            ...
            if self.render_default_scale:
                self.domain_padding_default_scale = DomainPadding(domain_padding=domain_padding, padding_mode=domain_padding_mode, output_scaling_factor=None)
        else:
        ...
        self.fno_blocks = FNOBlocks(
            ...
            SpectralConv=SpectralConv,
            n_layers=n_layers)
            #render_default_scale=self.render_default_scale)
    ...
    def forward(self, x):
        ...
        if self.domain_padding is not None:
            ...
            if self.render_default_scale:
                x_default_scale = self.domain_padding_default_scale.pad(x)
        ...
        if self.domain_padding is not None:
            ...
            if self.render_default_scale:
                x_default_scale = self.domain_padding_default_scale.unpad(x_default_scale)
